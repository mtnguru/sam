 ...
 */
function zen_atom_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface &$form_state, $form_id = NULL) {
  ...
  $form['zen_atom_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('zen_atom sample setting'),
  '#default_value' => theme_get_setting('zen_atom_example'),
